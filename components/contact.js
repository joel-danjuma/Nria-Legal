          ...
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              ...
              <span className="inline-flex">
                <a id="Facebook" href="#" className="text-gray-500">
                  <svg
                    fill="currentColor"
                ...
                <a id="Twitter" href="#" className="ml-4 text-gray-500">
                  <svg
                    fill="currentColor"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                ...
                <a id="Instagram" href="#" className="ml-4 text-gray-500">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
                ...
                <a id="Telegram" href="#" className="ml-4 text-gray-500">
                  <svg
                    fill="currentColor"
                    stroke-linecap="round"
                    stroke-linejoin="round"
